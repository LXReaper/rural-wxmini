<template>
  ...
  <view>
    <scroll-view>
      <uni-search-bar class="uni-mt-10" radius="5" placeholder="请输入搜索内容" clear-button="auto" cancel-button="none"
                      @confirm="search" />

      <swiper class="swiper-style" indicator-dots="ture" autoplay="ture" interval="10000" duration="200"
              circular="ture">
